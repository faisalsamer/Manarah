...
# ============================================================================
# Aliases — preserve singular import names used by the existing codebase.
# ============================================================================
User = Users
Bank = Banks
Account = Accounts
...
ExpenseNotification = ExpenseNotifications
Marsa = Marasi
MarsaTransaction = MarasiTransactions
MarsaAttempt = MarasiAttempts
MarsaNotification = MarasiNotifications
ZakatAsset = ZakatAssets
ZakatLiability = ZakatLiabilities
ZakatPayment = ZakatPayments
ZakatPaymentReceiver = ZakatPaymentReceivers
ZakatCalculation = ZakatCalculations
ZakatCalculationAsset = ZakatCalculationAssets
