...
/**
 * Expenses-flavored stat card: rounded, elevated, with a tinted icon chip.
 * Lives in the expenses module rather than `components/ui/` so we keep the
 * generic `Stat` primitive untouched.
 */
