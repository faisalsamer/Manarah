...
import { pageLabels } from '@/lib/marasi/labels';

export interface MarasiHeaderProps {
  onNewMarsa: () => void;
}

export function MarasiHeader({ onNewMarsa }: MarasiHeaderProps) {
  return (
    <header className="relative flex flex-col sm:flex-row sm:items-end justify-between gap-6 pb-10 mb-10 border-b border-border">
      <div className="min-w-0">
        <span className="inline-flex items-center gap-2 px-3 py-1 mb-4 rounded-full bg-primary-50 text-primary-600 text-caption font-semibold tracking-[0.12em] uppercase">
